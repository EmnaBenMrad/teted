...
if(strtolower($list_group)=="td-administrators"){ $valid_imputation = "actif"; $update_imputation = "actif"; $rapport_imputation = "actif"; $rapport_projet = "actif";  $rapport_facturation = "actif"; }
    ...
    <TD bgColor="#cc0000">
      <TABLE cellSpacing="0" cellPadding="0" border="0" height="21">
        ...
        <TR>
          ...
          onmouseout="this.className='navItem'" vAlign=center noWrap 
          align="middle">&nbsp;&nbsp; <A id=home_link 
            title="<?php echo strtoupper($tab_parametres['valid_imputation']);?>" href="valid_imputation.php"><?php echo strtoupper($tab_parametres['valid_imputation']);?></A> &nbsp;&nbsp;</TD><?php }  if($update_imputation == "actif") { ?>
          <TD class="navItem" onMouseOver="this.className='navItemOver'" 
          onclick="window.document.location='update_imputation.php'" 
          onmouseout="this.className='navItem'" vAlign=center noWrap 
          align="middle">&nbsp;&nbsp; <A id=home_link 
            title="<?php echo strtoupper($tab_parametres['update_imp']);?>" href="update_imputation.php"><?php echo strtoupper($tab_parametres['update_imp']);?></A> &nbsp;&nbsp;</TD><?php }  if($rapport_imputation == "actif") { ?>
          <TD class="navItem" onMouseOver="this.className='navItemOver'" 
          onclick="window.document.location='rapport_imputation.php'" 
          onmouseout="this.className='navItem'" vAlign=center noWrap 
          align="middle">&nbsp;&nbsp; <A id=home_link 
            title="<?php echo strtoupper($tab_parametres['rapport_imputation']);?>" href="rapport_imputation.php"><?php echo strtoupper($tab_parametres['rapport_imputation']);?></A> &nbsp;&nbsp;</TD><?php } if($rapport_projet == "actif") { ?>
          <TD class="navItem" onMouseOver="this.className='navItemOver'" 
          onclick="window.document.location='rapport_projet.php'" 
          onmouseout="this.className='navItem'" vAlign=center noWrap 
          align="middle">&nbsp;&nbsp; <A id=home_link 
            title="<?php echo strtoupper($tab_parametres['rapport_projet']);?>" href="rapport_projet.php"><?php echo strtoupper($tab_parametres['rapport_projet']);?></A> &nbsp;&nbsp;</TD><?php } if($rapport_facturation == "actif") { ?>
          <TD class="navItem" onMouseOver="this.className='navItemOver'" 
          onclick="window.document.location='rapport_facturation.php'" 
          onmouseout="this.className='navItem'" vAlign=center noWrap 
          align="middle">&nbsp;&nbsp; <A id=home_link 
            title="<?php echo strtoupper($tab_parametres['rapport_facturation']);?>" href="rapport_facturation.php"><?php echo strtoupper($tab_parametres['rapport_facturation']);?></A> &nbsp;&nbsp;</TD><?php } ?>
