        ...
        <TR>
          <TD>
              ...
              if(isset($_GET['idp'])){
	              ...
	              <TR>
	                <TD valign="top" class=jiraformbody><?php echo $tab_parametres['page_gest_proj'];?></TD>
	              	...
	              	<div align="right" style="margin-top:50px"><a class="liens-bleu10b" href="gest_project_validation_cloture.php">Retour</a>&nbsp;&nbsp;&nbsp;&nbsp;</div>
				<table width="60%"  cellspacing="1" id="listeCollab" cellpadding="4" border="0" bgcolor="#bbbbbb" align="center" style="margin-top:30px">
	              ...
	              <table cellspacing="0" cellpadding="0" border="0" align="center" width="0%">
	                <tbody><tr>
	                  <td> <a class="liens-bleu10b" href="gest_project_validation_cloture.php?operation=ajouter&idp=<?php echo $_GET['idp'];?>"><img border="0" width="20" height="20" src="../images/valider.gif"></a></td>
	                </tr>
	              </tbody></table>      
				<?php }else{?>
				<div align="right" style="margin-top:50px"><a class="liens-bleu10b" href="gest_project_validation_cloture.php?idp=<?php echo $_GET['idp'];?>">Retour</a>&nbsp;&nbsp;&nbsp;&nbsp;</div>
				<form id="form1" name="form1" method="post" action="gest_project_validation_cloture.php?idp=<?php echo $_GET['idp'];?>">
			...
			<TABLE class="jiraform  maxWidth">
              <TBODY>
              <TR>
                <TD valign="top" class="jiraformheader"><H3 class=formtitle>Gestion de la validation des projets clôturés</H3></TD></TR>
              <TR>
                <TD valign="top" class=jiraformbody><?php echo $tab_parametres['page_gest_proj'];?></TD>
              </TR></TBODY></TABLE>
          ...
          $query="SELECT 
			...
			while($row = mysql_fetch_array($result)){ 
			    ...
			    <tr class="project-tr"><td bgColor=#ffffff><?php  echo $pname;?></td><td bgColor=#ffffff><?php  echo $liste;?></td><td bgColor=#ffffff><a href="gest_project_validation_cloture.php?idp=<?php  echo $id;?>"><img src='../images/config-configuration.png' style="cursor:pointer" width='25px'/></a></td></tr>
			<?php  }
			?>
