...
if (isset ( $_REQUEST ['logout'] )) { // si l'utilisateur clike sur le lien se deconnecter 
...
if (isset ( $_POST['week'] )) {
	...
	$week = $_REQUEST['week'];
} elseif(isset ( $_REQUEST['mm']) && isset ( $_REQUEST['y'])) {
	$week = weeknumber($_REQUEST['y'], $_REQUEST['mm'], '01');
	if($week>50 &&  $_REQUEST['mm'] =='01') {
		$week = weeknumber($_REQUEST['y']+1, 12, 31);
	}
}else {
...
$jour_fer = jour_ferD($mm,$y);// les jours ferie de mois
		  ...
		  <?php
				...
				if (isset ( $_POST ['update'] )) {
					...
					if($nb_fer!=0) 
					{
						...
						{
						$Date_fer = $fer[1];
						if(($date_lun==$Date_fer) && (!empty($lundi)) && (!empty($ancien_lundi))) { 
						$lun_fer = "vrai"; $val_fer = $lundi; $ancien_val_fer = $ancien_lundi; $up_trav_fer="vrai"; $input_lun = "vrai"; }
						if(($date_mar==$Date_fer) && (!empty($mardi)) && (!empty($ancien_mardi))) { 
						$mar_fer = "vrai"; $val_fer = $mardi; $ancien_val_fer = $ancien_mardi; $up_trav_fer="vrai";
						$input_mar = "vrai"; }
						if(($date_mer==$Date_fer) && (!empty($mercredi)) && (!empty($ancien_mercredi))) { 
						$input_mer = "vrai";
						$mer_fer = "vrai"; $val_fer = $mercredi; $ancien_val_fer = $ancien_mercredi; $up_trav_fer="vrai"; }
						if(($date_jeu==$Date_fer) && (!empty($jeudi)) && (!empty($ancien_jeudi))) {
						$input_jeu = "vrai"; 
						$jeu_fer = "vrai"; $val_fer = $jeudi; }
						if(($date_ven==$Date_fer) && (!empty($vendredi)) && (!empty($ancien_vendredi))) { 
						$input_ven = "vrai";
						$ven_fer = "vrai"; $val_fer = $vendredi; $ancien_val_fer = $ancien_vendredi;  $up_trav_fer="vrai";}
						if(($date_sam==$Date_fer) && (!empty($samedi)) && (!empty($ancien_samedi))) {
						$input_sam = "vrai"; 
						$sam_fer = "vrai"; $val_fer = $samedi; $ancien_val_fer = $ancien_samedi;  $up_trav_fer="vrai";}
						if(($date_dim==$Date_fer) && (!empty($dimanche)) && (!empty($ancien_dimanche))) { 
						$input_dim = "vrai";
						$dim_fer = "vrai"; $val_fer = $dimanche; $ancien_val_fer = $ancien_dimanche; $up_trav_fer="vrai"; }
						$lib_fer = $fer[2];
						}
					}
					...
					if ($tache != 0) {
						if (($jour != "faux") && (is_numeric ( $lundi )) && ($lundi <= 1) && ($tache != 0) && ($lundi >= 0) && ($insert_raf == "vrai") && ($check_conge_lun == "vrai") && $up_trav_fer !="vrai") {
						...
						if (($jour != "faux") && (is_numeric ( $mardi )) && ($mardi <= 1) && ($tache != 0) && ($mardi >= 0) && ($insert_raf == "vrai") && ($check_conge_mar == "vrai") && $up_trav_fer !="vrai") {
						...
						if (($jour != "faux") && (is_numeric ( $mercredi )) && ($mercredi <= 1) && ($tache != 0) && ($mercredi >= 0) && ($insert_raf == "vrai") && ($check_conge_mer == "vrai") && $up_trav_fer !="vrai") {
						...
						if (($jour != "faux") && (is_numeric ( $jeudi )) && ($jeudi <= 1) && ($tache != 0) && ($jeudi >= 0) && ($insert_raf == "vrai") && ($check_conge_jeu == "vrai") && $up_trav_fer !="vrai") {
						...
						if (($jour != "faux") && (is_numeric ( $vendredi )) && ($vendredi <= 1) && ($tache != 0) && ($vendredi >= 0) && ($insert_raf == "vrai") && ($check_conge_ven) && $up_trav_fer !="vrai") {
						...
						if ((($samedi != 0) and ($ancien_samedi == 0)) || (($dimanche != 0) and ($ancien_dimanche == 0))) {
							...
							if (($jour != "faux") && (is_numeric ( $samedi )) && ($samedi <= 1) && ($tache != 0) && ($samedi >= 0) && ($insert_raf == "vrai") && ($check_conge_sam) && $up_trav_fer !="vrai") {
							...
							if (($jour != "faux") && (is_numeric ( $dimanche )) && ($dimanche <= 1) && ($tache != 0) && ($dimanche >= 0) && ($insert_raf == "vrai") && ($check_conge_dim) && $up_trav_fer !="vrai") {
				...
				if (isset ( $_POST ['insert'] )) {
					...
					//	Si tt est bon alors il y'aura insertion dans la base
					if (($jour != "faux") && (is_numeric ( $lundi )) && ($lundi <= 1) && ($tache != 0) && ($lundi > 0) && ($insert_raf == "vrai") && ($check_conge_lun == "vrai") && $ins_trav_fer !="vrai") {
					...
					if (($jour != "faux") && (is_numeric ( $mardi )) && ($mardi <= 1) && ($tache != 0) && ($mardi > 0) && ($insert_raf == "vrai") && ($check_conge_mar == "vrai") && $ins_trav_fer !="vrai") {
					...
					if (($jour != "faux") && (is_numeric ( $mercredi )) && ($mercredi <= 1) && ($tache != 0) && ($mercredi > 0) && ($insert_raf == "vrai") && ($check_conge_mer == "vrai") && $ins_trav_fer !="vrai") {
						$mercredi = format_number ( $mercredi );
						$duree_conge = duree_conge ( $sous_taches );
					...
					if (($jour != "faux") && (is_numeric ( $jeudi )) && ($jeudi <= 1) && ($tache != 0) && ($jeudi > 0) && ($insert_raf == "vrai") && ($check_conge_jeu == "vrai") && $ins_trav_fer !="vrai") {
						$jeudi = format_number ( $jeudi );
						$duree_conge = duree_conge ( $sous_taches );
					...
					if (($jour != "faux") && (is_numeric ( $vendredi )) && ($vendredi <= 1) && ($tache != 0) && ($vendredi > 0) && ($insert_raf == "vrai") && ($check_conge_ven == "vrai") && $ins_trav_fer !="vrai") {
						$duree_conge = duree_conge ( $sous_taches );
...
<TABLE cellSpacing="0" cellPadding="0" width="100%" bgColor="#bbbbbb"
  ...
  <?php
		for($i = ($mois_deb - 1); $i < $mois_fin; $i ++) {
			?>
  <option
										value="suivi_imputation.php?mm=<?php
			echo ($i + 1);
			?>&y=<?php
			echo $y;
			?>"
...
<OPTION value="<?php
									...
									?>"
										<?php
									if ((isset ( $_REQUEST ['insert'] ) || isset ( $_REQUEST ['update'] )) and ($sous_taches == $row1 [0])) {
										echo "selected";
									}
									?>><?php
									echo $row1 [1] . "&nbsp;:&nbsp;" . $row1 [2];
...
<?php
	  ...
	  <?php
			...
			if (((($ins_trav_fer == "vrai") || ($up_trav_fer == "vrai")) && ($test_week != "vrai") && ($update_week != "vrai")) and ($tache != 0)) {
				$chaine = "Vous avez travailler le jour de " . $lib_fer.', ce jour est un jour ferie souhaitez vous confirmer ?';
				?> 
...
<?php
			...
			if ((isset ( $raf )) and empty ( $raf ) ) {
				if(!isset($_POST['raf']) ||(isset($_POST['raf']) && $_POST['raf'] =="")){
