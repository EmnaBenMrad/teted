...
<option value="Priorite" <?php if (@$_POST['axex']=='Priorite') {echo 'selected';}?>>Priorit�</option>
...
<option value="Priorite" <?php if (@$_POST['axey']=='Priorite') {echo 'selected';}?>>Priorit�</option>
...
?>
              ...
              <option >Consomm�</option>
<option value="RAF" <?php if (@$_POST['mesure']=='RAF') {echo 'selected';}?> >RAF</option>
<option value="Prevu" <?php if (@$_POST['mesure']=='Prevu') {echo 'selected';}?> >Pr�vu</option>
<option value="Avancement" <?php if (@$_POST['mesure']=='Avancement') {echo 'selected';}?> >Avancement</option>
<option value="Previsionel" <?php if (@$_POST['mesure']=='Previsionel') {echo 'selected';}?> >Pr�visionel</option>
                    </select><br /><br />
		</td>
                     </tr>
                   <tr  valign="middle" class="txte-bleu10b" bgcolor="#EFEFEF">
