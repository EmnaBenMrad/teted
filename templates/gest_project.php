        ...
        <TR>
          <TD>
            <TABLE class="jiraform  maxWidth">
              <TBODY>
              <TR>
                <TD valign="top" class="jiraformheader"><H3 class=formtitle><?php echo $tab_parametres['gest_project'];?></H3></TD></TR>
              <TR>
...
switch ($_GET['operation']) {
    case "ajouter";
        ?>
           <form id="form1" name="form1" method="post" action="projects.php">
<table class="jiraform" width="60%" align="center">
              <tr class='jiraformheader'>
                ...
                <td valign='top'><?php $query2="SELECT * from project order by pname"; // Ajout de Status
...
<input name="Editer" type="submit" value="<?php echo $tab_parametres['ajout'];?> >>" />
       ...
       case "supprimer";
	?>
	<form id="form3" name="form3" method="post" action="projects.php">
	<?php $query="SELECT * FROM tetd_project_exclusive WHERE ID=$idf"; // Suoppression de Status
...
<br/>
            <table width="60%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#bbbbbb">
              <tr class="jiraformheader">
                ...
                <td align="center" valign="top" class="style2" ><?php echo $tab_parametres['supprimer'];?></td>
			              ...
			              <?php $query="SELECT * FROM tetd_project_exclusive ORDER BY pname "; // Affichge de la liste des Status
 ...
 ?>
              <tr bgcolor="#FFFFFF">
                ...
                <td align="center" valign="top"> <a href="gest_project.php?operation=supprimer&idf=<?php echo($row1[0]);?>" class="liens-bleu10b"><img src="../images/supprimer.gif"  border="0" /></a></td>
              </tr><?php } ?>
            </table>
            <br />
                <br />
              ...
              <table width="0%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td> <a href="gest_project.php?operation=ajouter" class="liens-bleu10b"><img src="../images/valider.gif" width="20" height="20"  border="0" /></a></td>
                </tr>
              </table>
              <br />
