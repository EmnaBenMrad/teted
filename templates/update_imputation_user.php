...
code lié aux paramètrage des pages 
*****************/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="149">
  ...
  <tr>
    ...
    <TABLE cellSpacing="0" cellPadding="1" width="100%" align="center" 
		  ...
		  <?php  
//des variables initialisé pour étre utilisé aprés ds l'affichage de l'alerte
$jourvide=1;
$num=1;
$imp=1;
$vide=1;
...
$proj = $_POST['proj'];
//Si une des variables n'est pas défini alor elle sera initialisé à0 pour pouvoir la traiter ds le bloc is_numeric
...
{
$jour = "faux";
$vide=0; //ça sert pour afficher le message d'erreur en bas de page si tte les imputations sont vides
}

//voir si au moin une imputation n'est pas numérique
...
$numerique = "faux";
$num=0; //ça sert pour afficher le message d'erreur en bas de page si une des imputations a une valeur non numérique
}


//voir si au moin une imputation a une valeur supérieur à 1
...
$imputation = "faux";
$imp=0; //ça sert pour afficher le message d'erreur en bas de page si une des imputations a une valeur > à 1
}
...
$imputation = "faux";
$negatif="vrai"; //ça sert pour afficher le message d'erreur en bas de page si une des imputations a une valeur < à 0
}
...
$proj = $_POST['proj'];
//Si une des variables n'est pas défini alor elle sera initialisé à 0 pour pouvoir la traiter ds le bloc is_numeric
if (empty($lundi)) { $lundi = 0; }
if (empty($mardi)) { $mardi = 0; }
if (empty($mercredi)) { $mercredi = 0; }
if (empty($jeudi)) { $jeudi = 0; }
...
if ($raf < 0) { $input_raf = "vrai"; }
$imputation = "faux";
$negatif="vrai"; //ça sert pour afficher le message d'erreur en bas de page si une des imputations a une valeur > à 1
}
...
<TABLE cellSpacing="0" cellPadding="0" width="100%" 
         ...
         <td height="10" colspan="13" align="left">
		  <?php /********** mettre les mois de l'année dans un tableau ***********/
...
?>
      <?php //requéte de sélection des imputations 
...
if(((($test_week=="vrai") ||($update_week=="vrai")) && (($ins_trav_fer=="vrai") || ($up_trav_fer=="vrai")) && (($msg_sam=="tru") ||($msg_dim=="tru")))&& ($jour!="faux") && ($tache!=0) ) 
 { 
 $chaine = "Vous avez imputez du temps les jours du week-end et un jour férié. Souhaitez vous confirmer ?
"; ?>
<TABLE cellSpacing="0" cellPadding="1" width="60%" align="center" 
            bgColor="#bbbbbb" border="0">
              <TR>
                    ...
                    <TR>
                      <TD vAlign="top" width="180%" bgColor="#EFEFEF">
                        <TABLE cellSpacing="0" cellPadding="0" width="100%">
                          <TBODY>
                          <TR>
                            <TD vAlign="top" width="80%" bgColor="#EFEFEF" align="center"><font color="#CC0000"><b><?php echo $chaine;   if (($date_jour_fer == "faux")  and ($tache!=0)) { echo "Cejour n'est pas un jour férié"; } ?></b></font><br />
